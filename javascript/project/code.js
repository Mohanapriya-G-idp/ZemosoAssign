...
var str=document.getElementById("btn");
    ...
    str.addEventListener("click",loremString)
...
var convertInch=document.getElementById("btn4")
convertInch.addEventListener("click",convertToFt)
...
var convertfeet=document.getElementById("btn5")
convertfeet.addEventListener("click",convertToInch)
...
var compare=document.getElementById("btn6")
compare.addEventListener("click",compareTwoWords)
...
//random password
document.getElementById("bt7").addEventListener("click",randomPass)
function randomPass(){
...
document.getElementById("bt8").addEventListener("click",evenOdd)
function evenOdd(){
...
//random colour
document.getElementById("bt9").addEventListener("click",randomColor)
...
document.getElementById("bt10").addEventListener("click",randomName)
function randomName(){
